    ...
    for f=1:numel(filtering_rule)
        ...
        for cc=1:numel(concurrent_cliques)
            for g=1:numel(enable_guiding)
                ...
                [error_rate, theoretical_error_rate, error_distance] = gbnn_test(network, sparsemessages, ...
                                                                                      l, c, Chi, ...
                                                                                      ...
                                                                                      residual_memory, concurrent_cliques(1,cc), no_concurrent_overlap, concurrent_successive, GWTA_first_iteration, GWTA_last_iteration, ...
                                                                                      silent);

                % Store the results
                D(m,counter) = density;
                E(m,counter) = error_rate;
                ED(m, counter) = error_distance;
